...
DECLARE
    ...
    _migration _ps_catalog.migration = row ('001-create-ext-schema.sql', '0.8.0');
...
CREATE OR REPLACE FUNCTION _prom_ext."num_cpus"() RETURNS INT /* i32 */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'num_cpus_wrapper';
...
IMMUTABLE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'rewrite_fn_call_to_subquery_wrapper';
...
IMMUTABLE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'tag_map_rewrite_wrapper';
...
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 're2_match_wrapper';
...
-- src/aggregates/vector_selector.rs:158
...
CREATE OR REPLACE FUNCTION _prom_ext."vector_selector_transition"(
	...
	"start_time" timestamp with time zone, /* pgx::datum::time_stamp_with_timezone::TimestampWithTimeZone */
	"end_time" timestamp with time zone, /* pgx::datum::time_stamp_with_timezone::TimestampWithTimeZone */
	"bucket_width" bigint, /* i64 */
	"lookback" bigint, /* i64 */
	"time" timestamp with time zone, /* pgx::datum::time_stamp_with_timezone::TimestampWithTimeZone */
	"value" double precision /* f64 */
) RETURNS internal /* pgx::datum::internal::Internal */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'vector_selector_transition_wrapper';

-- src/aggregates/vector_selector.rs:233
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'vector_selector_combine_wrapper';

-- src/aggregates/vector_selector.rs:208
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'vector_selector_final_wrapper';

-- src/aggregates/prom_rate.rs:3
CREATE SCHEMA IF NOT EXISTS _prom_ext; /* promscale::aggregates::prom_rate::_prom_ext */

-- src/aggregates/prom_rate.rs:15
-- promscale::aggregates::prom_rate::_prom_ext::prom_rate_transition
CREATE OR REPLACE FUNCTION _prom_ext."prom_rate_transition"(
	"state" internal, /* pgx::datum::internal::Internal */
	"lowest_time" timestamp with time zone, /* pgx::datum::time_stamp_with_timezone::TimestampWithTimeZone */
	"greatest_time" timestamp with time zone, /* pgx::datum::time_stamp_with_timezone::TimestampWithTimeZone */
	"step_size" bigint, /* i64 */
	"range" bigint, /* i64 */
	"sample_time" timestamp with time zone, /* pgx::datum::time_stamp_with_timezone::TimestampWithTimeZone */
	"sample_value" double precision /* f64 */
) RETURNS internal /* pgx::datum::internal::Internal */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'prom_rate_transition_wrapper';

-- src/aggregates/prom_increase.rs:3
CREATE SCHEMA IF NOT EXISTS _prom_ext; /* promscale::aggregates::prom_increase::_prom_ext */

-- src/aggregates/prom_increase.rs:15
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'prom_extrapolate_final_wrapper';
...
-- src/iterable_jsonb.rs:10
-- creates:
--   Type(promscale::iterable_jsonb::Jsonb)



-- src/jsonb_digest.rs:34
...
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'jsonb_digest_wrapper';
...
-- src/aggregates/vector_selector.rs:216
...
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'vector_selector_serialize_wrapper';

-- src/aggregates/vector_selector.rs:227
...
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'vector_selector_deserialize_wrapper';
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('001-extension.sql', '0.8.0');
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'gapfilldeltatransition_in_wrapper';
...
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.8.0', 'gapfilldeltatransition_out_wrapper';
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('002-utils.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('003-users.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('004-schemas.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('005-tag-operators.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('006-tables.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('007-matcher-operators.sql', '0.8.0');
    _body TEXT = $migrationbody$----------------------------------
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('008-install-uda.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('009-tables-ha.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('010-tables-metadata.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('011-tables-exemplar.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('012-tracing.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('013-tracing-well-known-tags.sql', '0.8.0');
    _body TEXT = $migrationbody$/*
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('014-telemetry.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('015-tracing-redesign.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('016-remove-ee-schemas.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('017-set-search-path.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('018-grant-prom-roles.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('019-prom-installation-info.sql', '0.8.0');
    _body TEXT = $migrationbody$
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('020-series-partitions.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('021-initial-default.sql', '0.8.0');
    _body TEXT = $migrationbody$
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('022-jit-off.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('023-privileges.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('024-adjust_autovacuum.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('025-tag-map-storage-type.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('026-remove-name-param.sql', '0.8.0');
    _body TEXT = $migrationbody$
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('027-tag-map-storage-views.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('028-refactor-mark-unused-series.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('029-remove-unused-ingest-func.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('030-remove-get-confirmed-unused-series.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('031-remove-superfluous-tag_v-ops.sql', '0.8.0');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('032-remove-non-empty-span-name-constraint.sql', '0.8.0');
    _body TEXT = $migrationbody$-- Our tracing implementation is based on OTLP spec, though OTLP spec
...
BEGIN
    ...
    WHERE name = _migration.name;
    IF _migration_name IS NOT NULL THEN
        RAISE LOG 'Migration "032-remove-non-empty-span-name-constraint.sql" already applied, skipping';
        -- 001-extension.sql changes are expected until this issue is resolved: https://github.com/timescale/promscale_extension/issues/350
        -- 024-adjust_autovacuum.sql had a bug in it and had to be changed
        IF _body_differs AND _migration_name != '001-extension.sql' and _migration_name != '024-adjust_autovacuum.sql' THEN
            RAISE WARNING 'The contents of migration "032-remove-non-empty-span-name-constraint.sql" have changed';
        END IF;
        RETURN;
    END IF;
...
$inner_migration_block$;
    ...
    INSERT INTO _ps_catalog.migration (name, applied_at_version, body) VALUES (_migration.name, _migration.applied_at_version, _body);
    RAISE LOG 'Applied migration 032-remove-non-empty-span-name-constraint.sql';
END;
$outer_migration_block$;
-- 033-metric-view.sql
DO
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('033-metric-view.sql', '0.8.0');
    _body TEXT = $migrationbody$DO $block$
BEGIN
...
BEGIN
    ...
    WHERE name = _migration.name;
    IF _migration_name IS NOT NULL THEN
        RAISE LOG 'Migration "033-metric-view.sql" already applied, skipping';
        -- 001-extension.sql changes are expected until this issue is resolved: https://github.com/timescale/promscale_extension/issues/350
        -- 024-adjust_autovacuum.sql had a bug in it and had to be changed
        IF _body_differs AND _migration_name != '001-extension.sql' and _migration_name != '024-adjust_autovacuum.sql' THEN
            RAISE WARNING 'The contents of migration "033-metric-view.sql" have changed';
        END IF;
        RETURN;
    END IF;
...
$inner_migration_block$;
    ...
    INSERT INTO _ps_catalog.migration (name, applied_at_version, body) VALUES (_migration.name, _migration.applied_at_version, _body);
    RAISE LOG 'Applied migration 033-metric-view.sql';
END;
$outer_migration_block$;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('034-maintenance-job-stats.sql', '0.8.0');
    _body TEXT = $migrationbody$CREATE TYPE _ps_catalog.signal_type
...
BEGIN
    ...
    WHERE name = _migration.name;
    IF _migration_name IS NOT NULL THEN
        RAISE LOG 'Migration "034-maintenance-job-stats.sql" already applied, skipping';
        -- 001-extension.sql changes are expected until this issue is resolved: https://github.com/timescale/promscale_extension/issues/350
        -- 024-adjust_autovacuum.sql had a bug in it and had to be changed
        IF _body_differs AND _migration_name != '001-extension.sql' and _migration_name != '024-adjust_autovacuum.sql' THEN
            RAISE WARNING 'The contents of migration "034-maintenance-job-stats.sql" have changed';
        END IF;
        RETURN;
    END IF;
...
$inner_migration_block$;
    ...
    INSERT INTO _ps_catalog.migration (name, applied_at_version, body) VALUES (_migration.name, _migration.applied_at_version, _body);
    RAISE LOG 'Applied migration 034-maintenance-job-stats.sql';
END;
$outer_migration_block$;
-- 035-remove-func.sql
DO
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('035-remove-func.sql', '0.8.0');
    _body TEXT = $migrationbody$
...
BEGIN
    ...
    WHERE name = _migration.name;
    IF _migration_name IS NOT NULL THEN
        RAISE LOG 'Migration "035-remove-func.sql" already applied, skipping';
        -- 001-extension.sql changes are expected until this issue is resolved: https://github.com/timescale/promscale_extension/issues/350
        -- 024-adjust_autovacuum.sql had a bug in it and had to be changed
        IF _body_differs AND _migration_name != '001-extension.sql' and _migration_name != '024-adjust_autovacuum.sql' THEN
            RAISE WARNING 'The contents of migration "035-remove-func.sql" have changed';
        END IF;
        RETURN;
    END IF;
...
$inner_migration_block$;
    ...
    INSERT INTO _ps_catalog.migration (name, applied_at_version, body) VALUES (_migration.name, _migration.applied_at_version, _body);
    RAISE LOG 'Applied migration 035-remove-func.sql';
END;
$outer_migration_block$;
-- 001-base.sql
