...
DECLARE
    ...
    _migration _ps_catalog.migration = row ('001-create-ext-schema.sql', '0.5.1');
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'num_cpus_wrapper';
...
IMMUTABLE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'rewrite_fn_call_to_subquery_wrapper';
...
IMMUTABLE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'tag_map_rewrite_wrapper';
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'vector_selector_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'vector_selector_final_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'vector_selector_combine_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'prom_rate_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'prom_increase_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'prom_delta_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'prom_extrapolate_final_wrapper';
...
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'vector_selector_serialize_wrapper';
...
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'vector_selector_deserialize_wrapper';
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.1', 'jsonb_digest_wrapper';
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('001-extension.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('002-utils.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('003-users.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('004-schemas.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('005-tag-operators.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('006-tables.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('007-matcher-operators.sql', '0.5.1');
    _body TEXT = $migrationbody$----------------------------------
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('008-install-uda.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('009-tables-ha.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('010-tables-metadata.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('011-tables-exemplar.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('012-tracing.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('013-tracing-well-known-tags.sql', '0.5.1');
    _body TEXT = $migrationbody$/*
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('014-telemetry.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('015-tracing-redesign.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('016-remove-ee-schemas.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('017-set-search-path.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('018-grant-prom-roles.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('019-prom-installation-info.sql', '0.5.1');
    _body TEXT = $migrationbody$
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('020-series-partitions.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('021-initial-default.sql', '0.5.1');
    _body TEXT = $migrationbody$
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('022-jit-off.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('023-privileges.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('024-adjust_autovacuum.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('025-tag-map-storage-type.sql', '0.5.1');
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('026-remove-name-param.sql', '0.5.1');
    _body TEXT = $migrationbody$
