...
DECLARE
    ...
    _migration _ps_catalog.migration = row ('001-create-ext-schema.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "001-create-ext-schema.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'num_cpus_wrapper';
...
IMMUTABLE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'tag_map_rewrite_wrapper';
...
IMMUTABLE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'rewrite_fn_call_to_subquery_wrapper';
...
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 're2_match_wrapper';
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'vector_selector_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'vector_selector_final_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'vector_selector_combine_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'prom_rate_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'prom_increase_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'prom_delta_transition_wrapper';
...
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'prom_extrapolate_final_wrapper';
...
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'vector_selector_serialize_wrapper';
...
IMMUTABLE PARALLEL SAFE STRICT
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'vector_selector_deserialize_wrapper';
...
LANGUAGE c /* Rust */
AS '$libdir/promscale-0.5.4', 'jsonb_digest_wrapper';
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('001-extension.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "001-extension.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('002-utils.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "002-utils.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('003-users.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "003-users.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('004-schemas.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "004-schemas.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('005-tag-operators.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "005-tag-operators.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('006-tables.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "006-tables.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('007-matcher-operators.sql', '0.5.4');
    _body TEXT = $migrationbody$----------------------------------
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "007-matcher-operators.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('008-install-uda.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "008-install-uda.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('009-tables-ha.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "009-tables-ha.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('010-tables-metadata.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "010-tables-metadata.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('011-tables-exemplar.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "011-tables-exemplar.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('012-tracing.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "012-tracing.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('013-tracing-well-known-tags.sql', '0.5.4');
    _body TEXT = $migrationbody$/*
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "013-tracing-well-known-tags.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('014-telemetry.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "014-telemetry.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('015-tracing-redesign.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "015-tracing-redesign.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('016-remove-ee-schemas.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "016-remove-ee-schemas.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('017-set-search-path.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "017-set-search-path.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('018-grant-prom-roles.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "018-grant-prom-roles.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('019-prom-installation-info.sql', '0.5.4');
    _body TEXT = $migrationbody$
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "019-prom-installation-info.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('020-series-partitions.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "020-series-partitions.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('021-initial-default.sql', '0.5.4');
    _body TEXT = $migrationbody$
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "021-initial-default.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('022-jit-off.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "022-jit-off.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('023-privileges.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "023-privileges.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('024-adjust_autovacuum.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "024-adjust_autovacuum.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('025-tag-map-storage-type.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "025-tag-map-storage-type.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('026-remove-name-param.sql', '0.5.4');
    _body TEXT = $migrationbody$
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "026-remove-name-param.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('027-tag-map-storage-views.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "027-tag-map-storage-views.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('028-refactor-mark-unused-series.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "028-refactor-mark-unused-series.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('029-remove-unused-ingest-func.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "029-remove-unused-ingest-func.sql" has changed';
        END IF;
        RETURN;
    END IF;
...
DECLARE
    _migration_name TEXT = NULL;
    _body_differs BOOL = false;
    _migration _ps_catalog.migration = row ('030-remove-get-confirmed-unused-series.sql', '0.5.4');
...
BEGIN
    ...
    IF _migration_name IS NOT NULL THEN
        ...
        IF _body_differs THEN
            RAISE WARNING 'Checksum of migration "030-remove-get-confirmed-unused-series.sql" has changed';
        END IF;
        RETURN;
    END IF;
